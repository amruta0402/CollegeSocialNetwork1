...
public class PlacementOfficerController {
	...
	public PlacementOfficer addPlacementOfficer(@Valid@RequestBody PlacementOfficerDTO placementOfficerDTO) {
		PlacementOfficer placementOfficer = new PlacementOfficer(placementOfficerDTO.getStudentId(),placementOfficerDTO.getRequirements(),placementOfficerDTO.getPlaceStudent());
